...
export default function RoomForm({ closeForm, theme }) {
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          className={
            theme === "dark"
              ? "bg-gray-800 rounded-lg mx-4 p-6 shadow-lg max-w-md w-full"
              : "bg-white rounded-lg mx-4 p-6 shadow-lg max-w-md w-full"
          }
